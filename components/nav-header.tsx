    ...
    >
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <a
            href="/Ravi-kr-sharma.pdf"
            download={true}
            key={"cv-download"}
            className={cn(
              "text-emerald-600 text-lg rounded-lg px-2 py-2 flex items-center gap-4"
            )}
          >
        ...
        <section
          className={`bg-gradient-to-tr bg-purple-700/60 dark:bg-background/90 backdrop-blur-xl shadow-2xl from-purple-700/60 via-pink-500/10 to-blue-900/80 transition-all duration-200 ease-linear absolute top-0 left-0 h-screen md:hidden z-50 overflow-hidden ${
            isNavbarActive ? "w-[264px] p-4 py-2" : "p-0 m-0 box-border w-[0px]"
          }`}
        >
          <div className="text-white flex items-center justify-between gap-1">
            ...
            <div
              className="text-5xl font-thin rotate-45 cursor-pointer"
              onClick={handleClick}
            >
              +
            </div>
